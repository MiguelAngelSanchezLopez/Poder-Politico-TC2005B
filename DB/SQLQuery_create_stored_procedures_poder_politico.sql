...
@edad int
AS
    INSERT INTO CandidatosPresidenciales VALUES (@nombreCandidato,@apellidoCandidato,@edad)
GO
...
/*Pruebas
EXEC insertCandidatosPresidenciales 1,'jorge','maynez',31,'cambiar mexico','4 ejes'
EXEC updateCandidatos 2,'xochitl','galvez',65,'who','impuestos'
EXEC getallCandidatos
EXEC deleteCandidatos 1
*/
...
AS
    INSERT INTO Usuarios VALUES (@nombre,@correo,@contrasenia)
GO
